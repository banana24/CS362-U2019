...
int main() {
   ...
   for ( i=0; i<5; i++){
	 ...
	 choice2 = gold; //Gain a card value higher than +3
	 choice1 = 1; //Removed repetitive test for a new one
	 printf("Trashing treasure for treasure card worth more in cost than +3 of itself\n");
	 assertTrue(-1,r); 
      }
	 ...
	 assertTrue(-1,r); 
      ...
      r = mineEffect(&state, currentPlayer, handPos, choice1, choice2); 
